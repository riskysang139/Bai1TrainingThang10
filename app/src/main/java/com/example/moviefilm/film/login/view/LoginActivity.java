package com.example.moviefilm.film.login.view;
...
import com.example.moviefilm.film.login.model.User;
import com.example.moviefilm.film.login.viewmodels.LoginViewModels;
    ...
    private void observedLogin() {
        ...
        loginViewModels.getUserMutableLiveData().observe(this, new Observer<User>() {
            ...
            public void onChanged(User user) {
                ...
                } else if (user.getEmail().equalsIgnoreCase("Admin") && user.getPassWord().equalsIgnoreCase("Admin")) {
